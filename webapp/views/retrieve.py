...
@view_config(
    route_name="retrieve_submission",
    renderer="../templates/retrieve_submissions.jinja2",
)
def retrieve_view(request):
    if "submit" in request.params:
        ...
        if query:
            ...
            resultsLink = "location.href='result/{}/{}'".format(
                analysisType, process_ID
            )
            return {
                "style": "display:block;",
                "submission": query,
                "submissionID": process_ID,
